...
def robotPrueba(x,y):
    ...
    Brazos = compound([AnteBrazoL, AnteBrazoR, BrazoL, BrazoR])
    robot1 = compound([Base, Lado1, Lado2, Lado3, Lado4, Rueda1, Rueda2, RuedaCastor, Brazos, centro])
    robot2 = compound([Base, Lado1, Lado2, Lado3, Lado4, Rueda1, Rueda2, RuedaCastor, Brazos, centro])
